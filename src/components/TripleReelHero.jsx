...
export default function TripleReelHero({ reels, eyebrow, caption, contentOffsetY = 0 }) {
  return (
    <section className="relative flex min-h-[70svh] items-center overflow-hidden bg-espresso md:min-h-[100svh]">
      <div className="absolute inset-0 grid grid-cols-3 gap-px bg-bone/15 md:gap-1">
      ...
      <div
        className="relative z-10 mx-auto flex min-h-[70svh] w-full max-w-[1600px] flex-col justify-end px-6 pb-14 md:min-h-[100svh] md:px-[8vw] md:pb-20"
